      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-8 text-foreground/80">
          <section>
            ...
            <p>
              Les présentes Conditions Générales de Vente (CGV) régissent les relations contractuelles entre MoonWave Records et ses clients. En commandant nos services, vous acceptez sans réserve les présentes CGV.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Les présentes CGV ont pour objet de définir les conditions dans lesquelles MoonWave Records fournit ses services de production musicale, distribution, promotion et publishing aux artistes et clients.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Pour toute question concernant ces CGV, contactez-nous à : <a href="mailto:contact@moonwaverecords.com" className="text-primary hover:underline">contact@moonwaverecords.com</a>
            </p>
          </section>
        </div>
      </div>
